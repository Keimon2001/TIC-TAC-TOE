...
public class TicTacToe {
    ...
    /**
     *
     * @param i Aquesta variable representa que son els huecos que hi han al tauler.
     * Si aquesta variable esta en -3, significa que esta buid i per tant retorna un espai en buid '_'
     * En cas de que l'usuari, o el programa hagi ficat un cercle o una creu, aquest retorna el que pertoca.
     * @return
     */
    ...
    /**
     *
     * @param taulerJoc Aquesta variable es el tauler de Joc on fiquem creu o cercle
     * El que fa aquest metode es, amb les variables random, amb un bound de 3,
     * afegira el cercle a un lloc random mentres que sigui diferent de -3, per tant
     * no podra ficar-se sobre de una x.
     */
    ...
    /**
     *
     * @param taulerJoc Aquesta variable es el tauler on veurem les creus o els cercles
     * El que fa aquest metode es demanar per consola on volem tirar, i acte seguid fiquem 'X' als llocs que pertoquen.
     */
